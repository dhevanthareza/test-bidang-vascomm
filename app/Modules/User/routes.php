...
use App\Modules\User\Controller\CustomerController;
...
Route::prefix('/user')->group(function () {
    ...
    Route::prefix('/customer')->group(function () {
        ...
        Route::post('/activation/{user_id}', [CustomerController::class, 'activate']);
        Route::post('/deactivation/{user_id}', [CustomerController::class, 'deactivate']);
    });
